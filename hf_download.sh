...
# bash hf_download.sh -r [remote-model-dir] -l [local-save-dir]
# ********************
# download dataset from huggingface: 
# bash hf_download.sh -r [remote-dataset-dir] -l [local-save-dir] -y [repo_type]
# ********************
# download model needed token from huggingface: 
# bash hf_download.sh -r [remote-model-dir] -l [local-save-dir] -t [huggingface user access tokens]
# ********************
# command usage help
# bash hf_download.sh -h
# ********************

# usage example:
# ********************
# download Qwen1.5-14B-Chat model from huggingface: 
# bash hf_download.sh -r Qwen/Qwen1.5-14B-Chat -l qwen1_5-14b-chat
# ********************
# download tatsu-lab/alpaca dataset from huggingface: 
# bash hf_download.sh -r tatsu-lab/alpaca -l alpaca -y dataset
# ********************
# download meta-Llama3-Instruct model from huggingface: 
# bash hf_download.sh -r meta-llama/Meta-Llama-3-8B-Instruct -l llama3-8b-instruct -t hf****
